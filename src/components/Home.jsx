...
const Home = () => {
    return (
        <div name='home' className='w-full h-screen bg-[#497359]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <p className='text-[#fabfbc] py-4 max-w-[700px]'>I'am a Full Stack Software Engineer specializing in Game Development and XR
                ...
                <div>
                    <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#5DAA7A] hover:border-[#5DAA7A]'>View Work
